...
description: "### Scott Winship’s individualized Earned Income Tax Credit proposal"
pubDate: '2023-07-14'
---
...
#### An analysis and note on the value of open-source models.


![](https://cdn-images-1.medium.com/max/800/1*qwkZz_5RZ5k3NF17iCQMhQ.jpeg)
...
![](https://cdn-images-1.medium.com/max/800/0*0EhFGZyfMcDJ5bi5)
...
![](https://cdn-images-1.medium.com/max/800/0*z_QMwgr6-SHd1oU5)
...
- Cost $38.2 billion in 2023
- Benefit 13% of the population
- Lower poverty by 0.7% and child poverty by 1.3%, disproportionately among Hispanic Americans
- Lower deep poverty by 0.4% and deep child poverty by 0.6%
- Lower the Gini index of income inequality by 0.7%
- Increase the share of households facing cliffs by 16%
...
![](https://cdn-images-1.medium.com/max/800/0*dt4R1nm9QxO11v28)
...
- Open source models facilitate better policy analysis. We were only able to diagnose the discrepancy because the Tax-Calculator and Tax-Data code are publicly available on GitHub, as was AEI analyst Bodi Yang’s code that produced the estimates. Those who have identified opportunities to improve our own open source software have improved our policy analysis as well.
- The Current Population Survey outperforms the IRS Public Use File for some policy questions. We use the CPS to capture personal relationships within a household, benefit receipt, poverty, and other factors absent from the sample of tax returns in the IRS Public Use File. This comes at a cost: the CPS truncates income more than the PUF, has more measurement error, and lacks some characteristics like specific deductions. We will address those deficiencies by integrating the datasets later this year, but in the meantime, this analysis revealed a particular research question where the CPS can outperform the PUF.
- Stochastic imputations produce more realistic data. If Tax-Data applied a stochastic technique, such as quantile regression, it would have produced greater spread of the spousal earnings share, compared to the constant approach. When we integrate PUF information into the CPS, we will do so using the survey-enhance software package we developed to combine the accuracy of machine learning with the stochasticity of quantile regression (here’s our working paper).
...
By [Max Ghenis](https://medium.com/@maxghenis) on [July 14, 2023](https://medium.com/p/b655e68f3882).

[Canonical link](https://medium.com/@maxghenis/scott-winships-individualized-earned-income-tax-credit-proposal-b655e68f3882)

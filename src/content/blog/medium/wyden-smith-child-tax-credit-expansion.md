...
description: "### Wyden-Smith Child Tax Credit Expansion"
pubDate: '2024-01-11'
---


### Wyden-Smith Child Tax Credit Expansion
...
![Senator Ron Wyden (D-OR)](https://cdn-images-1.medium.com/max/800/0*AtXQ49k-uYjbY-yy.jpg)
...
[Click here to see how the Wyden-Smith proposal would affect your own household’s 2023 taxes.](https://policyengine.org/us/household?focus=intro&reform=44066&region=us&timePeriod=2023&baseline=2)
...
- Raising the refundable CTC amount: The maximum ACTC would rise from $1,600 to $1,800 in 2023, from $1,700 to $1,900 in 2024, and from $1,700 to the full $2,000 in 2025, with the amount indexed to inflation thereafter.
- Phasing in the refundable CTC with the number of children: Rather than a flat 15% phase-in rate, the CTC would phase in at 15% times the number of qualifying children.
- Allowing prior years’ income to count toward the CTC calculation: Guggenheim did not provide further detail on this provision, nor is PolicyEngine currently equipped to model it, given we use cross-sectional survey and tax data for our projections.
...
![](https://cdn-images-1.medium.com/max/800/0*bV6_hQkfJ4Oq4TMK)
...
![](https://cdn-images-1.medium.com/max/800/0*bO4aeUdIBSTe9cGQ)
...
![](https://cdn-images-1.medium.com/max/800/0*j1z2Wmv_ShPm_jVN)
...
![](https://cdn-images-1.medium.com/max/800/1*1X9iN18E4d2D11aSSN6NBQ.png)
...
![](https://cdn-images-1.medium.com/max/800/0*ZO7CVih4HQQ6BiN4)
...
![](https://cdn-images-1.medium.com/max/800/0*buBusyS9y4OmYCjA)
...
By [Max Ghenis](https://medium.com/@maxghenis) on [January 11, 2024](https://medium.com/p/44d4ab49453d).

[Canonical link](https://medium.com/@maxghenis/wyden-smith-child-tax-credit-expansion-44d4ab49453d)

...
description: "### Distributional analysis of Andrew Yang’s Freedom Dividend"
pubDate: '2019-06-24'
---
...
- $1,000 per month to every adult citizen [progressive]
- Rescinding of benefits for households who opt for the basic income (they can keep their current benefits if they want); the Freedom Dividend does not replace Social Security, Medicare, Medicaid, housing, or unemployment insurance [regressive]
- A 10 percent value added tax (VAT, a form of consumption tax common across Europe) [regressive]
- A 0.1 percent, $50 billion per year financial transaction tax (FTT) [progressive]
- A $20 per ton carbon tax (Yang also proposes an additional $20 per ton carbon tax to fund clean energy investments, which is not modeled here) [roughly flat]
- Lifting the cap on Social Security contributions [progressive]
- Treating capital gains as ordinary income [progressive]
...
![](https://cdn-images-1.medium.com/max/800/1*NNtBE0MYGZlJG3KMa1j18Q.png)
...
![](https://cdn-images-1.medium.com/max/800/1*IwC9v5AG6SVtPPuv6E84oQ.png)
...
![](https://cdn-images-1.medium.com/max/800/1*JnWf8F0dEu8dM6Hbel6y6w.png)
...
![](https://cdn-images-1.medium.com/max/800/0*_6S7Fv4_NZmekSvk)


![](https://cdn-images-1.medium.com/max/800/0*XCHRUsbNMOY-zWwY)
...
![](https://cdn-images-1.medium.com/max/800/1*FeRFFxtkP4o9-xl7UVbctA.png)
...
![](https://cdn-images-1.medium.com/max/800/1*wpOSfcgTSnGgd6_gyMlsAA.png)
...
![](https://cdn-images-1.medium.com/max/800/1*FdcZFFLrFFuNitz-mF8I1g.png)
...
![](https://cdn-images-1.medium.com/max/800/0*RulBXc2rBL6sBYvX)

The calculator also shows the range of effects, similarly to the blue and orange chart above:


![](https://cdn-images-1.medium.com/max/800/1*qxMH_G2Z0kI5kbz5wTyEeg.png)
...
![](https://cdn-images-1.medium.com/max/800/1*ZuXPrjwE1gM-nv2ux7VCBA.png)


![](https://cdn-images-1.medium.com/max/800/1*0h4yeBJIBAWSu-eNftvvHw.png)
...
![](https://cdn-images-1.medium.com/max/800/0*LkSHyRE0m1-VLDM_)
...
![](https://cdn-images-1.medium.com/max/800/0*h2a_Vsom8NRCLW41)
...
By [Max Ghenis](https://medium.com/@maxghenis) on [June 24, 2019](https://medium.com/p/d8dab818bf1b).

[Canonical link](https://medium.com/@maxghenis/distributional-analysis-of-andrew-yangs-freedom-dividend-d8dab818bf1b)

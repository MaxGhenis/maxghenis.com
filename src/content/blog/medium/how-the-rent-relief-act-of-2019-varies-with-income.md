---
title: "How the rent relief act of 2019 varies with income and location"
description: "### How the Rent Relief Act of 2019 Varies with Income and Location"
pubDate: '2024-08-22'
---
...
#### We show the impact on different households of the bill introduced by then-Senator Kamala Harris.


![](https://cdn-images-1.medium.com/max/800/0*1tDL5nfwwLuqMVIH)
...
- 2017: Rep. Joseph Crowley (D-NY) introduced the initial version with eight cosponsors.
- 2018: Rep. Scott Peters (D-CA) reintroduced it in the House; Sen. Kamala Harris introduced a Senate companion bill.
- 2019: Sen. Harris and Rep. Danny Davis (D-IL) reintroduced it in the Senate and House, respectively, reducing the maximum rent from 150% to 100% of fair market rent.
- 2022: Rep. Davis and Sen. Raphael Warnock (D-GA) reintroduced the bill.
- 2023: Rep. Davis reintroduced it without a Senate companion.
...
- Thresholds are $25,000 higher in areas that use SAFMRs instead of FMRs (which HUD defines at the metro level) for the Housing Choice Voucher program
...
![](https://cdn-images-1.medium.com/max/800/0*_bG50g06m6fg3p2c)
...
![](https://cdn-images-1.medium.com/max/800/0*EPuCVy97aGQvFyUk)
...
![](https://cdn-images-1.medium.com/max/800/0*aWj1gSnt06wvXQAS)
...
![](https://cdn-images-1.medium.com/max/800/0*TVnDJ119xe338vNK)
...
![](https://cdn-images-1.medium.com/max/800/0*IUCRsmREyRmi5cj-)
...
![](https://cdn-images-1.medium.com/max/800/0*laJ8B-XezYYRjNIA)
...
By [Max Ghenis](https://medium.com/@maxghenis) on [August 22, 2024](https://medium.com/p/f409a62e407c).

[Canonical link](https://medium.com/@maxghenis/how-the-rent-relief-act-of-2019-varies-with-income-and-location-f409a62e407c)

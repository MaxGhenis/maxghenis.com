...
description: "### How would reforms affect cliffs?"
pubDate: '2023-02-02'
---
...
#### The PolicyEngine US app now computes the impact of custom policy reforms on the prevalence and severity of cliffs.
...
![](https://cdn-images-1.medium.com/max/800/0*ea-iCNObVVa3blyM)
...
![](https://cdn-images-1.medium.com/max/800/0*xRJCp7bnW-lab73G)
...
![](https://cdn-images-1.medium.com/max/800/0*s39iTSIqO-BaRzWP)
...
- Cliff rateShare of households who would be worse off if each adult earned $2,000 more per year
- Cliff gapTotal net income lost by households when adults earn an additional $2,000
...
### Experiment 1: Increase the SSI earned income exclusion
...
![](https://cdn-images-1.medium.com/max/800/0*oQaGBVePzhukcZWq)

See Appendix B for caveats around PolicyEngine’s SSI microsimulation model.


### Experiment 2: Repeal SNAP emergency allotments
...
![](https://cdn-images-1.medium.com/max/800/0*MScerJywMqvSjAWJ)
...
![](https://cdn-images-1.medium.com/max/800/0*BWzaOy8sULhqP-X3)


### Experiment 3: Start phasing out Washington’s Working Families Tax Credit at a lower income
...
![](https://cdn-images-1.medium.com/max/800/0*NiYobhSg_1kDdWZR)
...
![Impacts of selected reforms on cliffs and other outcomes](https://cdn-images-1.medium.com/max/800/1*sphHryjtjLOBIRJcX30xvg.png)
...
![](https://cdn-images-1.medium.com/max/800/0*vMeICnyMyfSe4f9_)


![](https://cdn-images-1.medium.com/max/800/0*r7SK9ZwRhPeL7mf8)
...
![](https://cdn-images-1.medium.com/max/800/0*MEK7DtIlWNLOkJ9G)


![](https://cdn-images-1.medium.com/max/800/0*BFO-3rIyT4OP_Q72)
...
- Assign blindness to respondents who report vision difficulty in the CPS.
- Assign disability to respondents who report any difficulty in the CPS.
- Calculate the share of the ABD (aged, blind, or disabled) population that would meet other SSI requirements except for income, such as asset limits and disability certification, as well as take-up conditional on eligibility, in order to match the SSA’s total SSI enrollment records.We estimate that 59% of the ABD population would participate in SSI based on non-income-based eligibility requirements and take-up.
- Assign SSI eligibility randomly to 59% of the ABD population.
...
- The Department of Health and Human Services’s Marginal Tax Rate Series
- The Congressional Budget Office’s study on Effective Marginal Tax Rates
- The Atlanta Fed’s CLIFF Dashboard
- ImagineLA’s Social Benefit Navigator for Los Angeles, using the BenefitKitchen API
- CrossPurpose’s cliff dashboard
- Georgia Center for Opportunity’s BenefitsCliffs.org calculator
- Leap Fund’s BenefitsCliff.com resource
...
By [Max Ghenis](https://medium.com/@maxghenis) on [February 2, 2023](https://medium.com/p/c390fffcfdf7).

[Canonical link](https://medium.com/@maxghenis/how-would-reforms-affect-cliffs-c390fffcfdf7)

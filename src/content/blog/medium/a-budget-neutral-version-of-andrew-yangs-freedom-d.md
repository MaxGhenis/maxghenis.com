...
description: "### A budget-neutral version of Andrew Yang’s Freedom Dividend"
pubDate: '2019-06-24'
---


### A budget-neutral version of Andrew Yang’s Freedom Dividend
...
- $1,000 per month to every adult citizen
- Rescinding of benefits for households who opt for the basic income (they can keep their current benefits if they want); the Freedom Dividend does not replace Social Security, Medicare, Medicaid, unemployment insurance, or housing
- A 10 percent value added tax (VAT, a form of consumption tax common across Europe)
- A 0.1 percent, $50 billion per year financial transaction tax (FTT)
- A $20 per ton carbon tax (Yang also proposes an additional $20 per ton carbon tax to fund clean energy investments, which is not modeled here)
...
![](https://cdn-images-1.medium.com/max/800/1*N7NeaP3IRqoHyYNOCDvazw.png)
...
![](https://cdn-images-1.medium.com/max/800/0*vYUjJnqv23y1_V8d)
...
![](https://cdn-images-1.medium.com/max/800/1*DIWhTa4TVIprP36tVUb9gQ.png)
...
![](https://cdn-images-1.medium.com/max/800/1*HUwBV2MNUpDj9tuxdsRhBw.png)
...
![](https://cdn-images-1.medium.com/max/800/0*oeFCDyVTKbSggO2X)
...
![](https://cdn-images-1.medium.com/max/800/1*ndEYM2FwpkMRclhIm_Vigw.png)
...
![](https://cdn-images-1.medium.com/max/800/1*PZ-m6BenNQHKc71gXHdYqA.png)

Various measures of poverty and inequality would fall:

- Poverty falls 35 percent, as defined by the share of people in households with disposable income below the federal poverty guideline.Not an official poverty measure.
...
![](https://cdn-images-1.medium.com/max/800/1*FWy9F9qpxGOq5lkHlLySHw.png)
...
![](https://cdn-images-1.medium.com/max/800/1*2bMWsZpvEw2MvZYm57t12A.png)
...
![](https://cdn-images-1.medium.com/max/800/0*1IwXTUdzxKuAI7Ao)
...
![](https://cdn-images-1.medium.com/max/800/1*yMCVcrYsmWCt-AE60l69Kw.png)
...
By [Max Ghenis](https://medium.com/@maxghenis) on [June 24, 2019](https://medium.com/p/d7d517dbeeea).

[Canonical link](https://medium.com/@maxghenis/a-revenue-neutral-version-of-andrew-yangs-freedom-dividend-d7d517dbeeea)

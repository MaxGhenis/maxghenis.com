...
description: "### Introducing the OBBBA Household Explorer"
pubDate: '2025-07-03'
---
...
#### New interactive tool reveals household-level impacts of the One Big Beautiful Bill Act.


![](https://cdn-images-1.medium.com/max/800/0*xog72axU8gc_8T_x)

Following the Senate’s July 1st passage of the One Big Beautiful Bill Act (OBBBA), we’re launching the [OBBBA Household Explorer](https://policyengine.org/us/obbba-household-explorer) — an interactive dashboard that shows how this reconciliation bill would affect individual households across America.

[Explore Households with our new tool here.](https://policyengine.org/us/obbba-household-explorer)
...
![](https://cdn-images-1.medium.com/max/800/0*femrvCx4TOJ3ea_3)
...
![](https://cdn-images-1.medium.com/max/800/0*_xZhF7_TUE_RT5Eh)
...
![](https://cdn-images-1.medium.com/max/800/0*42RcvRHuC_8TJdD2)
...
![](https://cdn-images-1.medium.com/max/800/0*PmdWaNAceYNyVgMW)
...
![](https://cdn-images-1.medium.com/max/800/0*QZQGbe-JhdRw7ifM)
...
- Using the Get Random Household button to quickly survey diverse impacts
- Applying filters to find households similar to yours
- Selecting specific household IDs for detailed analysis
- Finding “interesting cases” — households with the largest positive or negative impacts
...
By [Max Ghenis](https://medium.com/@maxghenis) on [July 3, 2025](https://medium.com/p/4782a90ce7bc).

[Canonical link](https://medium.com/@maxghenis/introducing-the-obbba-household-explorer-4782a90ce7bc)

...
description: "### Make Everyone a Policymaker"
pubDate: '2021-10-15'
---
...
![A UBI Center report on funding universal basic income by reforming the UK personal tax allowance used the open-source microsimulation model that powers PolicyEngine.](https://cdn-images-1.medium.com/max/800/0*u2MatZNQhvAplTLa)
...
- We and Charles Bauman at the UBI Center produced the first report to integrate PolicyEngine, on funding universal basic income from a land value tax.
- PolicyEngine estimates that equalising Child Benefit rates between first-born and subsequent children would cost £1.7bn per year and cut child poverty by 4%.
- PolicyEngine estimates that repealing the personal tax allowance would raise 102 billion per year, and affect middle-income households more than low- and upper-income ones.
- The UBI Lab Network embedded our household calculator to their Resilience UBI proposal, showing visitors a personalised impact.
...
Max Ghenis and Nikhil Woodruff<br/>[PolicyEngine](http://policyengine.org) co-founders


![](https://cdn-images-1.medium.com/max/800/1*sKPTtD2QzO5FZQNdyRP-YQ.png)

By [Max Ghenis](https://medium.com/@maxghenis) on [October 15, 2021](https://medium.com/p/dc7b00bdb143).

[Canonical link](https://medium.com/@maxghenis/make-everyone-a-policymaker-dc7b00bdb143)

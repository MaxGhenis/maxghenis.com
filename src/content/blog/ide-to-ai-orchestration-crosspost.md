...
**Feb 24, 2025** — [Anthropic launches Claude Code](https://www.anthropic.com/news/claude-code)
...
**Nov 18, 2025** — [Google launches Antigravity](https://blog.google/technology/google-labs/antigravity/)
The "Manager view" paradigm. An agent-first development platform where you don't touch code—you manage agents.

**Nov 24, 2025** — [Anthropic launches Opus 4.5 + Claude Code in Desktop](https://www.anthropic.com/news/claude-4-5-opus)
Remote/cloud sessions in native app. Multiple parallel sessions with isolated git worktrees.

**Jan 6, 2026** — [Anthropic adds local Claude Code to Desktop](https://www.anthropic.com/news/local-claude-code)
...
This matches how I've been working—I typically run 5-10 Claude Code sessions simultaneously through [TerminalGrid](https://maxghenis.com/terminalgrid), spread across a 2x2 grid (sometimes with multiple tabs per cell, sometimes across two VS Code windows):
...
*Full post with interactive timeline: [maxghenis.com/blog/ide-to-ai-orchestration](https://maxghenis.com/blog/ide-to-ai-orchestration)*

          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-xl text-gray-600 mb-4">
                Policy Entrepreneur, Technologist, and Economist
              </p>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <Section title="Current work">
          <OrganizationTile
            ...
            description="As co-founder and CEO of PolicyEngine, I lead the development of open source software to simulate economic policies in the US and UK. Our nonprofit's tools help policymakers, researchers, and the public understand how tax and benefit reforms affect society. We model comprehensive social insurance programs including Medicaid, CHIP, ACA subsidies, SSI, and Social Security taxation across all 50 states."
            links={[]}
            className="mb-6"
          />
        </Section>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-600">
                With Jason DeBacker. Investigating how large language models perceive and simulate behavioral responses to tax policy changes. SSRN Working Paper, August 2025.
              </p>
            </a>
            <a
            ...
            >
              ...
              <p className="text-gray-600">
                ...
                Association meeting (November 2024).
              </p>
            </a>
          </div>
        </Section>
            ...
            {[
              {
                ...
                source: "Substack",
                date: "August 2025",
                href: "https://maxghenis.substack.com/p/vat-thresholds-revenues-and-the-role",
              },
              {
                title: "AI models favor Cuomo over Mamdani on NYC housing production",
                source: "Substack",
                date: "June 2025",
                href: "https://maxghenis.substack.com/p/ai-models-favor-cuomo-over-mamdani",
              },
              {
                title: "What Will the House Ways & Means Committee Propose on Tuesday?",
                source: "Substack",
                date: "May 2025",
                href: "https://maxghenis.substack.com/p/what-will-the-house-ways-and-means",
              },
              {
                title: "My 2024 in Code: Personal Projects & AI Tools",
                source: "Substack",
                date: "January 2025",
                href: "https://maxghenis.substack.com/p/my-2024-in-code-personal-projects",
              },
            ].map((article) => (
              <a
                key={article.href}
